...
const MATCHES = [
  { match_id: 'A-1',  date: '2026-06-11', teamA: 'México',        teamB: 'Sudáfrica',            group: 'A' },
  { match_id: 'A-2',  date: '2026-06-11', teamA: 'Corea del Sur', teamB: 'República Checa',      group: 'A' },
  { match_id: 'B-1',  date: '2026-06-12', teamA: 'Canadá',        teamB: 'Bosnia y Herzegovina', group: 'B' },
  { match_id: 'D-1',  date: '2026-06-12', teamA: 'Estados Unidos',teamB: 'Paraguay',             group: 'D' },
  { match_id: 'B-2',  date: '2026-06-13', teamA: 'Qatar',         teamB: 'Suiza',                group: 'B' },
  { match_id: 'C-1',  date: '2026-06-13', teamA: 'Brasil',        teamB: 'Marruecos',            group: 'C' },
  { match_id: 'C-2',  date: '2026-06-13', teamA: 'Haití',         teamB: 'Escocia',              group: 'C' },
  { match_id: 'D-2',  date: '2026-06-13', teamA: 'Australia',     teamB: 'Turquía',              group: 'D' },
  { match_id: 'E-1',  date: '2026-06-14', teamA: 'Alemania',      teamB: 'Curazao',              group: 'E' },
  { match_id: 'F-1',  date: '2026-06-14', teamA: 'Países Bajos',  teamB: 'Japón',                group: 'F' },
  { match_id: 'E-2',  date: '2026-06-14', teamA: 'Costa de Marfil',teamB: 'Ecuador',             group: 'E' },
  { match_id: 'F-2',  date: '2026-06-14', teamA: 'Suecia',        teamB: 'Túnez',                group: 'F' },
  { match_id: 'H-1',  date: '2026-06-15', teamA: 'España',        teamB: 'Cabo Verde',           group: 'H' },
  { match_id: 'G-1',  date: '2026-06-15', teamA: 'Bélgica',       teamB: 'Egipto',               group: 'G' },
  { match_id: 'H-2',  date: '2026-06-15', teamA: 'Arabia Saudita',teamB: 'Uruguay',              group: 'H' },
  { match_id: 'G-2',  date: '2026-06-15', teamA: 'Irán',          teamB: 'Nueva Zelanda',        group: 'G' },
  { match_id: 'I-1',  date: '2026-06-16', teamA: 'Francia',       teamB: 'Senegal',              group: 'I' },
  { match_id: 'I-2',  date: '2026-06-16', teamA: 'Irak',          teamB: 'Noruega',              group: 'I' },
  { match_id: 'J-1',  date: '2026-06-16', teamA: 'Argentina',     teamB: 'Argelia',              group: 'J' },
  { match_id: 'J-2',  date: '2026-06-16', teamA: 'Austria',       teamB: 'Jordania',             group: 'J' },
  { match_id: 'K-1',  date: '2026-06-17', teamA: 'Portugal',      teamB: 'RD Congo',             group: 'K' },
  { match_id: 'L-1',  date: '2026-06-17', teamA: 'Inglaterra',    teamB: 'Croacia',              group: 'L' },
  { match_id: 'L-2',  date: '2026-06-17', teamA: 'Ghana',         teamB: 'Panamá',               group: 'L' },
  { match_id: 'K-2',  date: '2026-06-17', teamA: 'Uzbekistán',    teamB: 'Colombia',             group: 'K' },
];
...
export default function Admin() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      setSuccess(`Stats del partido ${selectedMatch} cargadas. Puntos calculados para todas las ligas.`);
    ...
    <div>
      ...
      <div style={{ marginBottom: '1.5rem' }}>
        ...
        <select value={selectedMatch} onChange={e => setSelectedMatch(e.target.value)}
          style={{ background: '#0A0A0A', border: '1px solid #1E1E1E', borderRadius: '8px', padding: '0.7rem 1rem', color: '#F0F0F0', fontSize: '0.875rem', outline: 'none', cursor: 'pointer', minWidth: '320px' }}>
          <option value="">-- Elegir partido --</option>
          {MATCHES.map(m => <option key={m.match_id} value={m.match_id}>{m.date} · Grupo {m.group} · {m.teamA} vs {m.teamB}</option>)}
        </select>
      </div>
      ...
      {selectedMatch && match && (
        <div>
          <div style={{ display: 'flex', gap: '1rem', marginBottom: '1rem', flexWrap: 'wrap', fontSize: '0.72rem', color: '#666' }}>
            {[['MIN','Minutos'],['GOL','Goles'],['ASS','Asistencias'],['TIR','Tiros al arco'],['TA','Amarilla'],['TR','Roja'],['AG','Autogol'],['CS','Clean Sheet'],['PEN','Penales atajados'],['MOTM','Man of the Match']].map(([k,v]) => (
